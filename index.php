        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="fa55bd9" title="Форма отзывов"]') ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
...
<div class="reply">
    <div class="reply__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="b4cef92" title="Форма для задавания вопросов"]') ?>
    </div>
</div>
