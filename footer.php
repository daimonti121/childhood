        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <a href="<?php the_field('link_instagram', 2); ?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('link_facebook', 2); ?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('link_youtube', 2); ?>" class="footer__social-item">
            ...
            <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                <div class="footer__contacts">
                    <div class="footer__contacts-item">
                        <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/phone.svg" alt="телефон"
                            class="footer__contacts-logo">
                        <div class="footer__contacts-tel">
                            <a href="tel:+797867834347"><?php the_field('first_number', 2); ?></a>
                            <a href="tel:+797867834358"><?php the_field('second_number', 2); ?></a>
                        </div>
                    </div>
                    <div class="footer__contacts-item">
                        <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg"
                            alt="указатель" class="footer__contacts-logo">
